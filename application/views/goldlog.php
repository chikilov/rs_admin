		            ...
		            <table class="table table-borderless table-striped table-vcenter" id="playlog">
		                <thead>
		                    <tr>
		                        ...
		                        <th class="text-center">total_gold</th>
		                        <th class="visible-lg text-center">value1</th>
		                        <th class="hidden-xs text-center">value2</th>
...
<!-- Page JS Code -->
<script src="<?php echo $one->assets_folder; ?>/js/pages/goldlog.js"></script>
