...
<div class="content content-boxed">
    ...
    <div class="block">
        <div class="block-header bg-gray-lighter">
            <h3 class="block-title">아이템 로그</h3>
        </div>
		            ...
		            <table class="table table-borderless table-striped table-vcenter" id="playlog">
		                <thead>
		                    <tr>
		                        ...
		                        <th class="text-center">prev_count</th>
		                        <th class="text-center">curr_count</th>
...
<!-- Page JS Code -->
<script src="<?php echo $one->assets_folder; ?>/js/pages/itemlog.js"></script>
