            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                <div class="push-30-t push-50 animated fadeIn">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted push-15-t">Login Page for Rythem Star Manage</p>
                    </div>
                    <!-- END Login Title -->
                    ...
                    <form class="js-validation-login form-horizontal push-30-t" action="/Login/act" method="post">
                        ...
                        <div class="form-group push-30-t">
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                                ...
                                <button class="btn btn-sm btn-block btn-primary" id="btnRegister" type="button">Register</button>
                            </div>
                        </div>
                    </form>
                    <!-- END Login Form -->
