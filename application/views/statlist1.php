...
<div class="content content-boxed">
    ...
    <div class="block">
        <div class="block-header bg-gray-lighter">
            <h3 class="block-title">스테이지 현황</h3>
        </div>
		            ...
		            <table class="table table-borderless table-striped table-vcenter" id="messageinfo">
		                <thead>
		                    <tr>
		                        ...
		                        <th class="text-center">스테이지모드 이용계정 수</th>
		                        <th class="text-center">자유모드 이용계정 수</th>
		                    </tr>
		                </thead>
		                <tbody>
		                    <tr>
...
<script src="<?php echo $one->assets_folder; ?>/js/pages/statlist1.js"></script>
