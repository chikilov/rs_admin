...
var MessageInfoDatatables = function() {
    ...
    var initDataTableFullPagination = function() {
        jQuery('#playlog').dataTable({
	        ajax: {
				"type"   : "POST",
				"url"    : '/Character/characterloglist',
			...
			columns: [
				...
				{"className" : "text-center", "data" : "t1", "searchable": true},
				{"className" : "text-center", "data" : "v1", "searchable": true},
				{"className" : "text-center", "data" : "t2", "searchable": true},
				{"className" : "text-center", "data" : "v2", "searchable": true},
				{"className" : "text-center", "data" : "t3", "searchable": true},
				{"className" : "text-center", "data" : "v3", "searchable": true},
				{"className" : "text-center", "data" : "t4", "searchable": true},
				{"className" : "text-center", "data" : "v4", "searchable": true}
			],
