    ...
    var initDataTableFullPagination = function() {
        jQuery('#playlog').dataTable({
			...
			columns: [
				...
				{"className" : "text-center", "data" : "action", "searchable": true},
				{"className" : "text-center", "data" : "iid", "searchable": true},
				{"className" : "text-center", "data" : "prev_count", "searchable": true},
				{"className" : "text-center", "data" : "curr_count", "searchable": true},
