		            ...
		            <table class="table table-borderless table-striped table-vcenter" id="playlog">
		                <thead>
		                    <tr>
		                        ...
		                        <th class="hidden-xs text-center">lv</th>
		                        <th class="text-center">category</th>
		                        <th class="visible-lg text-center">description</th>
		                        <th class="hidden-xs text-center">cash</th>
		                        <th class="visible-lg text-center">fcash</th>
		                        <th class="visible-lg text-center">pcash</th>
		                        <th class="visible-lg text-center">total_cash</th>
		                        <th class="visible-lg text-center">value1</th>
		                        <th class="visible-lg text-center">value2</th>
		                        <th class="visible-lg text-center">value3</th>
		                    </tr>
		                </thead>
		                <tbody>
		                    <tr>
...
<!-- Page JS Code -->
<script src="<?php echo $one->assets_folder; ?>/js/pages/cashlog.js"></script>
