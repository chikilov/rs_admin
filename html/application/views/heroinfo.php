...
<div class="content content-boxed">
    ...
    <div class="block">
        <div class="block-header bg-gray-lighter">
            <h3 class="block-title">히어로 목록</h3>
        </div>
        <div class="block-content">
            <table class="table table-borderless table-striped table-vcenter" id="heroinfo">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 151px;">보유몬스터/펫</th>
                        <th class="hidden-xs text-center" style="width: 140px;">등급정보</th>
                        <th class="text-center">레벨</th>
                        <th class="visible-lg text-center">영혼석 보유 개수</th>
                        <th class="hidden-xs text-center">보유  능력</th>
                        <th class="hidden-xs text-center">보유  스킬</th>
...
<!-- Page JS Code -->
<script src="<?php echo $one->assets_folder; ?>/js/pages/heroinfo.js"></script>
