...
<div class="content content-boxed">
    ...
    <div class="block">
        <div class="block-header bg-gray-lighter">
            <h3 class="block-title">스테이지 현황 ( 일단위 성공 )</h3>
        </div>
		            ...
		            <table class="table table-borderless table-striped table-vcenter" id="messageinfo">
		                <thead>
		                    <tr>
		                        ...
		                        <th class="text-center">전체 플레이시도 횟수</th>
		                        <th class="text-center">성공횟수</th>
		                        <th class="text-center">유니크 플레이시도 횟수</th>
		                        <th class="text-center">유니크 성공횟수</th>
		                    </tr>
		                </thead>
		                <tbody>
		                    <tr>
...
<script src="<?php echo $one->assets_folder; ?>/js/pages/statlist4.js"></script>
