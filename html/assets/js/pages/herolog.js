    ...
    var initDataTableFullPagination = function() {
        jQuery('#playlog').dataTable({
			...
			columns: [
				...
				{"className" : "text-center", "data" : "hid", "searchable": true},
				...
				{"className" : "text-center", "data" : "object_id", "searchable": true},
				{"className" : "text-center", "data" : "json", "searchable": true}
			],
